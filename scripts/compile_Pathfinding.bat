...
call %VCVARS% x64
cd /d "%~dp0\.."
cl src\PathfindingGame.cpp /Iinclude /I "C:\SDK\SDL\include" /EHsc /std:c++17 /Febin\PathfindingGame.exe /Foobj\ /link /LIBPATH:"C:\SDK\SDL\lib\x64" SDL3.lib user32.lib gdi32.lib shell32.lib /SUBSYSTEM:CONSOLE
